...
<head>
	<meta charset="utf-8">
	<title>Survey</title>
	<link href="../css/SurveyForm.css" rel="stylesheet" type="text/css">
	...
	<div class="survey">
		...
		<?php
			...
			for ($i = 0; $i < $limit; $i++) { //limit is no. questions in survey
				...
				echo "<div class='tab'>", "<h3>",$question_text, "</h3>";
				...
				case "multiple-choice":
					...
					for ($j = 0; $j < $option_limit; $j++){
						...
						echo "<input type='radio' name='$i' value='$option_text' oninput='this.className = '''>
                        <span style='font-size: 16px; color: #ffff00; font-weight: bold;'>$option_text</span>";
